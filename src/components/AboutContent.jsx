            ...
            <div className="text-inner-wrap">
              <div className="text-flex">
                ...
                <p className="text-wrap">
                  I'm David, a 23 year-old Georgian self-taught developer. I
                  love challenging myself, whether it be learning new library or
                  solving a tricky problem. I always strive for greatness,
                  trying to better myself mentally and physically. Writing code
                  started as a hobby, but quickly grew into passion leading me
                  to read books on subject and perfect my craft.
                </p>
              </div>
              <div className="text-flex">
